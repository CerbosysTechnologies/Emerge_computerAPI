...
let uploadProdut = multer({ storage: storageProduct }).fields([
...
router.post(
  "/addProductType",
  uploadProdutType.single("image"),
  productTypeController.addProductType
);
...
router.put(
  "/updatePrductType/:product_type_id",
  uploadProdutType.single("image"),
...
router.get(
  "/getQualityTypeById/:quality_type_id",
  qualityTypeController.getQualityTypeById
);
router.put(
  "/updateQualiType/:quality_type_id",
  qualityTypeController.updateQualityType
);

//add product
router.post(
  "/addproduct",
  uploadgcpuMiddleware,
...
router.put(
  "/activateDeactivateProduct/:product_id/:status",
  productController.activateDeactivateProduct
);
